          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-gray-500 leading-relaxed" style={{ fontSize: '1rem' }}>
                Transparent pricing for AI security services. Choose a package that fits your needs, or build a custom engagement. All prices are negotiable - we're here to work with your budget.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-shadow" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li>• AI vulnerability assessment</li>
                <li>• Basic prompt injection defense</li>
                <li>• Input/output monitoring</li>
                <li>• Monthly security reports</li>
                <li>• Email support</li>
                <li>• Up to 2 AI models covered</li>
              </ul>
            ...
            <div className="bg-gray-50 border-2 border-gray-900 rounded-lg hover:shadow-lg transition-shadow relative" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li>• Comprehensive AI security audit</li>
                <li>• Advanced threat protection</li>
                <li>• Real-time anomaly detection</li>
                <li>• Data leakage prevention</li>
                <li>• AI red teaming (quarterly)</li>
                <li>• Up to 10 AI models covered</li>
            ...
            <div className="bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-shadow" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li>• Full AI security suite</li>
                <li>• 24/7 AI monitoring & response</li>
                <li>• Continuous red teaming</li>
                <li>• Compliance & governance setup</li>
                <li>• Custom policy development</li>
                <li>• Unlimited AI models covered</li>
        ...
        <div style={{ maxWidth: '90rem', margin: '0 auto', paddingLeft: '6rem', paddingRight: '4rem', paddingTop: '6rem', paddingBottom: '6rem' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-lg" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li className="flex justify-between">
                  <span>• Quick AI Security Assessment</span>
                  <span className="font-medium text-gray-900">$500</span>
                </li>
                <li className="flex justify-between">
                  <span>• Comprehensive AI Audit</span>
                  <span className="font-medium text-gray-900">$2,500</span>
                </li>
                <li className="flex justify-between">
                  <span>• AI/ML Penetration Testing</span>
                  <span className="font-medium text-gray-900">$3,000-$5,000</span>
                </li>
                <li className="flex justify-between">
                  <span>• AI Red Teaming Engagement</span>
                  <span className="font-medium text-gray-900">$5,000-$10,000</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li className="flex justify-between">
                  <span>• Prompt Injection Defense Setup</span>
                  <span className="font-medium text-gray-900">$1,200</span>
                </li>
                <li className="flex justify-between">
                  <span>• Data Leakage Prevention</span>
                  <span className="font-medium text-gray-900">$2,500</span>
                </li>
                <li className="flex justify-between">
                  <span>• Model Hardening Package</span>
                  <span className="font-medium text-gray-900">$3,000-$5,000</span>
                </li>
                <li className="flex justify-between">
                  <span>• PII Detection & Redaction</span>
                  <span className="font-medium text-gray-900">$1,500-$3,000</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li className="flex justify-between">
                  <span>• AI Compliance Readiness Check</span>
                  <span className="font-medium text-gray-900">$1,000</span>
                </li>
                <li className="flex justify-between">
                  <span>• AI Governance Implementation</span>
                  <span className="font-medium text-gray-900">$3,000-$8,000</span>
                </li>
                <li className="flex justify-between">
                  <span>• Bias & Fairness Audit</span>
                  <span className="font-medium text-gray-900">$2,000-$4,000</span>
                </li>
                <li className="flex justify-between">
                  <span>• AI Policy Development</span>
                  <span className="font-medium text-gray-900">$1,500-$3,000</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg" style={{ padding: '2rem' }}>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li className="flex justify-between">
                  <span>• AI Security Training Session</span>
                ...
                <li className="flex justify-between">
                  <span>• Additional Consulting Hours</span>
                  <span className="font-medium text-gray-900">$75/hour</span>
                </li>
                <li className="flex justify-between">
                  <span>• Ongoing Monitoring (add-on)</span>
                  <span className="font-medium text-gray-900">$99/month</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm">
              All prices are negotiable. Contact us to discuss a custom engagement tailored to your needs.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '90rem', margin: '0 auto', paddingLeft: '6rem', paddingRight: '4rem', paddingTop: '6rem', paddingBottom: '6rem' }}>
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-8" style={{ fontSize: '1.1rem' }}>
              We'll work with you to create an AI security engagement that fits your budget and requirements.
            </p>
